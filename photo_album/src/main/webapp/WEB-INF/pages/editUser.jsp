...
<body>
	...
	<c:url var="updateUserUrl" value="/updateUser.htm?userId=${User.userId}" />
	<c:url var="alluserphotoalbums" value="/${User.userId}/allUserPhotoAlbums.htm" />
	<c:url var="addFriendUrl" value="/${User.userId}/addFriend.htm" />
